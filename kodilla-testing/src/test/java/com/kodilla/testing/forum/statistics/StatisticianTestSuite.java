...
public class StatisticianTestSuite {
    ...
    public void testMorePosts() {
        ...
        //Then
        Assert.assertEquals(0.2, commentsPerPost, 0.0001);
    }
    ...
    public void testMoreComments() {
        ...
        //Then
        Assert.assertEquals(5, commentsPerPost, 0.0001);
    }
    ...
    public void testZeroUsers() {
        ...
        //Then
        Assert.assertEquals(-1, commentsPerUser, 0.0001);
    }
    ...
    public void testHundredUsers() {
        ...
        //Then
        Assert.assertEquals(0.1, postsPerUser, 0.0001);
    }
